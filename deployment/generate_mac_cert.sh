...
CERT_NAME="CivilMantraInternalSigning"
...
openssl pkcs12 -export -out "$CERT_NAME.p12" -inkey key.pem -in cert.pem -password pass:CivilMantra123!
...
echo "    security import $CERT_NAME.p12 -k $KEYCHAIN -P CivilMantra123! -T /usr/bin/codesign"
