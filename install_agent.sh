...
# ChronoTrack: Employee Agent & Desktop Client Installer
...
DAEMON_AUTOSTART_FILE="$HOME/.config/autostart/chronotrack-daemon.desktop"
...
CLIENT_AUTOSTART_FILE="$HOME/.config/autostart/chronotrack-client.desktop"
...
NoDisplay=false
X-GNOME-Autostart-enabled=true
Name=ChronoTrack Agent Desktop Portal
...
echo -e "\033[1;32m      CHRONOTRACK AGENT INSTALLATION COMPLETED SUCCESSFULLY  \033[0m"
echo -e "\033[1;32m============================================================\033[0m"
